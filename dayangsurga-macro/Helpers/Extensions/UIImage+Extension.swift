...
extension UIImage {
    ...
    static let icEducationFill = UIImage.image(named: "icEducationFill")
    ...
    static let icEducationActive = UIImage.image(named: "icEducationActive")
    static let icEducationFill = UIImage.image(named: "icEducationFill")
    static let icEducationInactive = UIImage.image(named: "icEducationInactive")
    static let icExperienceActive = UIImage.image(named: "icExperienceActive")
    static let icExperienceFill = UIImage.image(named: "icExperienceFill")
    static let icExperienceInactive = UIImage.image(named: "icExperienceInactive")
    static let icPersonalInformationActive = UIImage.image(named: "icPersonalInformationActive")
    static let icPersonalInformationFill = UIImage.image(named: "icPersonalInformationFill")
    static let icRoundSelectionFilled = UIImage.image(named: "icRoundSelectionFilled")
    static let icRoundSelectionNoFill = UIImage.image(named: "icRoundSelectionNoFill")
    ...
    static let icTechnicalSkillActive = UIImage.image(named: "icTechnicalSkillActive")
    static let icTechnicalSkillFill = UIImage.image(named: "icTechnicalSkillFill")
    static let icTechnicalSkillInactive = UIImage.image(named: "icTechnicalSkillInactive")
    static let imgCreateResume = UIImage.image(named: "imgCreateResume")
